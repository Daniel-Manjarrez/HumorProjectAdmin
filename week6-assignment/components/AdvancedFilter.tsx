        ...
        <div className="flex items-center gap-4 pb-4 border-b border-gray-100">
          ...
          <div className="flex gap-2 flex-1 max-w-md">
            <div className="relative flex-1">
              <select
                className="block w-full pl-3 pr-10 py-2 text-sm border border-gray-300 bg-gray-50 text-gray-900 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none cursor-pointer"
                value={sortBy}
            ...
            <button
              ...
              className="flex items-center justify-center px-4 py-2 border border-gray-300 bg-white text-gray-700 rounded-lg hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 transition-colors min-w-[100px]"
            >
              {sortOrder === 'asc' ? (
                <>
            ...
            return (
              <div key={filter.id} className="flex gap-2 items-center animate-fadeIn">
                <div className="relative w-1/3 md:w-1/4">
                  <select
                    className="block w-full pl-3 pr-8 py-2 text-sm border border-gray-300 bg-white text-gray-900 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none cursor-pointer"
                    value={filter.key}
                ...
                <div className="relative flex-1">
                  {currentColumn?.type === 'boolean' ? (
                    ...
                    <input
                      ...
                      className="block w-full pl-3 pr-3 py-2 text-sm border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
