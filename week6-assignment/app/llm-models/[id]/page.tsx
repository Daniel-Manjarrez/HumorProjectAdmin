      ...
      <div className="max-w-3xl mx-auto relative pt-8">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-xl rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 transition-colors">
          <div className="bg-gray-50 dark:bg-gray-900/50 px-6 py-4 border-b border-gray-200 dark:border-gray-700 transition-colors">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">LLM Model Details</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400 font-mono mt-1">ID: {model.id}</p>
          </div>
          ...
          <div className="p-6 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="mt-1 text-xl font-bold text-gray-900 dark:text-white">{model.name}</p>
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-500 dark:text-gray-400">Provider</label>
                <div className="mt-1">
                  <Link
              ...
              <div>
                <label className="block text-sm font-medium text-gray-500 dark:text-gray-400">Provider Model ID</label>
                <p className="mt-1 text-lg text-gray-900 dark:text-white font-mono bg-gray-50 dark:bg-gray-900/50 p-2 rounded inline-block transition-colors">
                  {model.provider_model_id}
                </p>
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-500 dark:text-gray-400">Temperature Support</label>
                <div className="mt-1">
